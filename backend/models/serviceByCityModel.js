...
const serviceByCitySchema = new mongoose.Schema(
  {
    title: { type: String, required: true, index: true },
    slug: { type: String, required: true, index: true },
    countryRef: { type: mongoose.Schema.Types.ObjectId, ref: "ServiceByCountry", index: true, default: null },
    ...
    blog: {
      heading: String,
      subtitle: String,
      // Admin-picked blog cards (up to 3). Empty → latest active blogs.
      selectedBlogs: [{ type: mongoose.Schema.Types.ObjectId, ref: "Blog" }],
    },
...
// Unique per citySlug+slug combination — same service slug can exist in different cities
serviceByCitySchema.index({ citySlug: 1, slug: 1 }, { unique: true });

module.exports = mongoose.models.ServiceByCity || mongoose.model("ServiceByCity", serviceByCitySchema);
