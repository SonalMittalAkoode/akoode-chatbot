...
const Faqs = () => {
    ...
    const faqData = homeFaqData;

    return (
        <section className="py-14 bg-[#fcfdfc] relative overflow-hidden">
            {/* Background Glows */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-6xl pointer-events-none">
                <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#EEF2FF] rounded-full blur-[120px] opacity-60"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#F0F9FF] rounded-full blur-[120px] opacity-60"></div>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                ...
                {/* FAQ list — CSS grid accordion for smooth height */}
                    ...
                    {faqData.map((item) => {
                        ...
                        >
                            ...
                            >
                                ...
                                {/* Toggle Icon */}
                                <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-[#474972] text-white transition-transform duration-200 ease-out" aria-hidden>
                                    {isOpen ? (
                            ...
                            {/* Answer — always rendered in DOM for crawler indexing;
