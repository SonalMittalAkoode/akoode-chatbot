          ...
          {TECH_CATS.map((cat, i) => (
            ...
            >
              ...
              <div className="mb-6 flex items-start gap-4">
                ...
                <div>
                  <h3 className="mb-1 text-[17px] sm:text-[18px] lg:text-[20px] font-semibold text-[#14153d]">
                    {cat.title}
                  </h3>
                  <div
                    className="text-[13px] sm:text-[14px] lg:text-[15px] leading-[1.6] text-[#62668a] [&_p]:m-0"
